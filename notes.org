...
*** DONE diceparser.py
*** TODO interpreter.py
*** TODO preprocessor.py
*** TODO dice.py
** Viewer
*** TODO implement axial labels and syntax for labels:
- Command *SPACE* parameter
** Bot
*** TODO implement the showing of images
**** TODO dice.py should be able to call to viewer to generate images directly
*** TODO implement limits for diceengine
*** TODO Multiline interpretation as multiple statements INCLUDING !define
* Dice Rules
** Examples
|-----------------------+-------------+----------------------------------------|
| Example               | Rule        | Result                                 |
